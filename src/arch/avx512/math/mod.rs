...
//!
//! The per-function submodules hold the intrinsic-style implementations
//! (`_mm512_sin_ps`, `_mm512_exp_pd`, …), one function per file.
...
use crate::arch::avx512::math::acos::{_mm512_acos_pd, _mm512_acos_ps};
use crate::arch::avx512::math::asin::{_mm512_asin_pd, _mm512_asin_ps};
use crate::arch::avx512::math::atan::{_mm512_atan_pd, _mm512_atan_ps};
use crate::arch::avx512::math::atan2::{_mm512_atan2_pd, _mm512_atan2_ps};
use crate::arch::avx512::math::cbrt::{_mm512_cbrt_pd, _mm512_cbrt_ps};
use crate::arch::avx512::math::cos::{_mm512_cos_pd, _mm512_cos_ps};
use crate::arch::avx512::math::exp::{_mm512_exp_pd, _mm512_exp_ps};
use crate::arch::avx512::math::ln::{_mm512_ln_pd, _mm512_ln_ps};
use crate::arch::avx512::math::pow::{_mm512_pow_pd, _mm512_pow_ps};
use crate::arch::avx512::math::sin::{_mm512_sin_pd, _mm512_sin_ps};
use crate::arch::avx512::math::tan::{_mm512_tan_pd, _mm512_tan_ps};
