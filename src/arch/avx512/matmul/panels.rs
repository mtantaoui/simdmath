...
//! input matrices into contiguous, 64-byte-aligned buffers laid out for the
//! microkernels ([`f32`](crate::arch::avx512::matmul::f32) uses 32×14 panels,
//! [`f64`](crate::arch::avx512::matmul::f64) 16×14):
//!
...
/// 64-byte alignment required by aligned AVX-512 loads (`_mm512_load_ps`
/// `_mm512_load_pd`).
const AVX_ALIGNMENT: usize = 64;
...
/// A contiguous, 64-byte-aligned buffer of packed panels, allocated once per
