...
//! (`_mm256_sin_ps`, `_mm256_exp_pd`, …), one function per file.
...
use crate::arch::avx2::math::acos::{_mm256_acos_pd, _mm256_acos_ps};
use crate::arch::avx2::math::asin::{_mm256_asin_pd, _mm256_asin_ps};
use crate::arch::avx2::math::atan::{_mm256_atan_pd, _mm256_atan_ps};
use crate::arch::avx2::math::atan2::{_mm256_atan2_pd, _mm256_atan2_ps};
use crate::arch::avx2::math::cbrt::{_mm256_cbrt_pd, _mm256_cbrt_ps};
use crate::arch::avx2::math::cos::{_mm256_cos_pd, _mm256_cos_ps};
use crate::arch::avx2::math::exp::{_mm256_exp_pd, _mm256_exp_ps};
use crate::arch::avx2::math::ln::{_mm256_ln_pd, _mm256_ln_ps};
use crate::arch::avx2::math::pow::{_mm256_pow_pd, _mm256_pow_ps};
use crate::arch::avx2::math::sin::{_mm256_sin_pd, _mm256_sin_ps};
use crate::arch::avx2::math::tan::{_mm256_tan_pd, _mm256_tan_ps};
