...
//! input matrices into contiguous, 32-byte-aligned buffers laid out for the
//! microkernels ([`f32`](crate::arch::avx2::matmul::f32) uses 16×6 panels,
//! [`f64`](crate::arch::avx2::matmul::f64) 8×6):
//!
...
/// 32-byte alignment required by aligned AVX2 loads (`_mm256_load_ps` /
/// `_mm256_load_pd`).
...
/// A contiguous, 32-byte-aligned buffer of packed panels, allocated once per
