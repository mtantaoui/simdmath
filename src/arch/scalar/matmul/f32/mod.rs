//! BLIS-style blocked matrix multiplication (f32) with scalar register-tile microkernels.
//!
...
//! a 8×6 scalar register-tile microkernel.
//!
//! ```text
...
use crate::arch::scalar::matmul::f32::kernels::{kernel_8x6, kernel_8x6_direct};
...
pub fn matmul_auto(a: &[f32], b: &[f32], c: &mut [f32], m: usize, n: usize, k: usize) {
    ...
    // starting point copied from the AVX2 crossover (see the `path_crossover` tuning test).
