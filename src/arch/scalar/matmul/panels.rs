...
//! microkernels ([`f32`](crate::arch::scalar::matmul::f32) uses 8×6 panels,
//! [`f64`](crate::arch::scalar::matmul::f64) 4×6):
//!
...
/// Panels are cache-line aligned. Scalar loads have no alignment requirement,
/// but line-aligned panels help the compiler auto-vectorise the kernel loops.
