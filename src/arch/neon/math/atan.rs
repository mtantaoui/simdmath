...
pub(crate) unsafe fn vatan_f64(x: float64x2_t) -> float64x2_t {
    unsafe {
        ...
        // id=0: (2·|x| − 1) / (2 + |x|)
        let t0 = vdivq_f64(vsubq_f64(vmulq_f64(two, abs_x), one), vaddq_f64(two, abs_x));
        ...
        let s1 = vmulq_f64(
            ...
            vfmaq_f64(
                ...
                vfmaq_f64(
                    at2,
                    w,
                    vfmaq_f64(at4, w, vfmaq_f64(at6, w, vfmaq_f64(at8, w, at10))),
                ),
            ),
        );
        ...
        let s2 = vmulq_f64(
            ...
            vfmaq_f64(
                at1,
                w,
                vfmaq_f64(at3, w, vfmaq_f64(at5, w, vfmaq_f64(at7, w, at9))),
            ),
        );
