...
//! (`vsin_f32`, `vexp_f64`, …), one function per file.
...
use crate::arch::neon::math::acos::{vacos_f32, vacos_f64};
use crate::arch::neon::math::asin::{vasin_f32, vasin_f64};
use crate::arch::neon::math::atan::{vatan_f32, vatan_f64};
use crate::arch::neon::math::atan2::{vatan2_f32, vatan2_f64};
use crate::arch::neon::math::cbrt::{vcbrt_f32, vcbrt_f64};
use crate::arch::neon::math::cos::{vcos_f32, vcos_f64};
use crate::arch::neon::math::exp::{vexp_f32, vexp_f64};
use crate::arch::neon::math::ln::{vln_f32, vln_f64};
use crate::arch::neon::math::pow::{vpow_f32, vpow_f64};
use crate::arch::neon::math::sin::{vsin_f32, vsin_f64};
use crate::arch::neon::math::tan::{vtan_f32, vtan_f64};
